...
const file_echo_proto_rawDesc = "" +
	...
	"\vechoService\x120\n" +
	"\x05Shout\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse\"\x00B\bZ\x06./echob\x06proto3"
...
var file_echo_proto_depIdxs = []int32{
	0, // 0: echo.echoService.Shout:input_type -> echo.EchoRequest
	1, // 1: echo.echoService.Shout:output_type -> echo.EchoResponse
